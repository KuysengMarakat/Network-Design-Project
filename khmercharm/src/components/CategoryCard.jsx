    ...
    <div className="group relative cursor-pointer">
      <div
        className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${
          gradientMap[category.color] || "from-gold-100 to-gold-200"
        } p-6 h-52 flex flex-col justify-between shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-white/60`}
      >
        {/* Background pattern */}
        ...
        <div className="relative z-10">
          ...
          <h3 className="font-display font-bold text-brown-900 text-xl leading-tight">
            {category.name}
          </h3>
