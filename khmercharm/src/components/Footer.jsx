...
export default function Footer() {
  ...
  const quickLinks = ["Home", "Shop", "Collections", "New Arrivals", "Sale"];
  const customerService = ["My Account", "Track Order", "Returns & Exchange", "Shipping Info", "FAQ"];
    ...
    <footer className="bg-brown-900 text-ivory/80" id="contact">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="flex gap-2 pt-2">
              {[
                ...
                <button
                  key={label}
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-white/10 hover:bg-gold-500 text-ivory/70 hover:text-white flex items-center justify-center transition-all duration-200 hover:scale-110"
                >
                  <Icon />
                </button>
              ))}
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link}>
                  <a
                    href="#"
                    className="text-sm text-ivory/60 hover:text-gold-400 transition-colors flex items-center gap-1.5 group"
                  >
          ...
          {/* Customer service */}
          <div className="space-y-4">
            <h4 className="font-display font-bold text-white text-base">Customer Service</h4>
            <ul className="space-y-2">
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h4 className="font-display font-bold text-white text-base">Contact Us</h4>
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm text-ivory/60">
                ...
                <a href="mailto:support@khmercharm.com" className="hover:text-gold-400 transition-colors">
                  support@khmercharm.com
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm text-ivory/60">
                <Phone className="w-4 h-4 text-gold-400 flex-shrink-0" />
                <a href="tel:+85512345678" className="hover:text-gold-400 transition-colors">
                  +855 12 345 678
                </a>
              </li>
            </ul>
            ...
            <div className="pt-2 p-3 bg-white/5 rounded-xl border border-white/10 text-xs text-ivory/50">
              ...
              <div>Sun: 9:00 AM – 6:00 PM (ICT)</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-ivory/40">
          <span>© {currentYear} KhmerCharm Accessories. All rights reserved.</span>
